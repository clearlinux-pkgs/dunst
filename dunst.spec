...
Version  : 1.10.0
Release  : 7
URL      : https://github.com/dunst-project/dunst/archive/v1.10.0/dunst-1.10.0.tar.gz
Source0  : https://github.com/dunst-project/dunst/archive/v1.10.0/dunst-1.10.0.tar.gz
...
%prep
%setup -q -n dunst-1.10.0
cd %{_builddir}/dunst-1.10.0
pushd ..
cp -a dunst-1.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708622677
