...
Version  : 1.12.2
Release  : 11
URL      : https://github.com/dunst-project/dunst/archive/v1.12.2/dunst-1.12.2.tar.gz
Source0  : https://github.com/dunst-project/dunst/archive/v1.12.2/dunst-1.12.2.tar.gz
...
%prep
%setup -q -n dunst-1.12.2
cd %{_builddir}/dunst-1.12.2
pushd ..
cp -a dunst-1.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741188328
...
rm -f %{buildroot}*/usr/etc/xdg/dunst/dunstrc
...
%files data
%defattr(-,root,root,-)
/usr/share/bash-completion/completions/dunst
/usr/share/bash-completion/completions/dunstctl
/usr/share/dbus-1/services/org.knopwob.dunst.service
/usr/share/fish/vendor_completions.d/dunst.fish
/usr/share/fish/vendor_completions.d/dunstctl.fish
/usr/share/fish/vendor_completions.d/dunstify.fish
/usr/share/zsh/site-functions/_dunst
/usr/share/zsh/site-functions/_dunstctl
