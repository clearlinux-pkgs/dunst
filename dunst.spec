...
Version  : 1.11.0
Release  : 8
URL      : https://github.com/dunst-project/dunst/archive/v1.11.0/dunst-1.11.0.tar.gz
Source0  : https://github.com/dunst-project/dunst/archive/v1.11.0/dunst-1.11.0.tar.gz
...
%prep
%setup -q -n dunst-1.11.0
cd %{_builddir}/dunst-1.11.0
pushd ..
cp -a dunst-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713276667
...
/usr/share/fish/vendor_completions.d/dunst
/usr/share/fish/vendor_completions.d/dunstctl
/usr/share/fish/vendor_completions.d/dunstify
