...
Version  : 1.5.0
Release  : 5
URL      : https://github.com/dunst-project/dunst/archive/v1.5.0/dunst-1.5.0.tar.gz
Source0  : https://github.com/dunst-project/dunst/archive/v1.5.0/dunst-1.5.0.tar.gz
...
%prep
%setup -q -n dunst-1.5.0
cd %{_builddir}/dunst-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602040375
...
cp %{_builddir}/dunst-1.5.0/LICENSE %{buildroot}/usr/share/package-licenses/dunst/5c497cb4ca1111f16e84b8338dc15fa9efad9ffa
